...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col w-full overflow-x-hidden pt-10">
      ...
      {/* Stats Ribbon */}
      <section className="py-12 sm:py-20 border-y border-border bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
       ...
       <section className="py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
              <div className="bg-card border-l-8 sm:border-l-12 border-l-primary border-y border-r border-border p-8 sm:p-12 rounded-r-3xl sm:rounded-r-[3rem] shadow-sm hover:shadow-xl transition-all">
              ...
              <div className="bg-foreground text-background p-8 sm:p-12 rounded-3xl sm:rounded-none sm:rounded-l-3xl shadow-2xl border-r-8 sm:border-r-12 border-r-primary hover:-translate-x-2 transition-all">
      ...
      <section className="py-24 bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((v, i) => (
                <div key={i} className="bg-card border-b-8 border-b-transparent hover:border-b-primary border border-border p-10 transition-all group">
