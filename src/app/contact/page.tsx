...
export default function ContactPage() {
  const branches = [
    {
      city: "Ahmedabad (HQ)",
      address: "Near Alpha One Mall, Vastrapur, Ahmedabad, Gujarat - 380015",
      phone: "+91 99999 88888",
      email: "ahmedabad@rexmyze.com",
    },
    {
      city: "Surat Center",
      address: "Adajan Road, Opposite Star Bazaar, Surat, Gujarat - 395009",
      phone: "+91 98888 77777",
      email: "surat@rexmyze.com",
    },
    {
      city: "Naroda Branch",
      address: "Galaxy Avenue, Near Naroda Lake, Ahmedabad - 382330",
      phone: "+91 97777 66666",
      email: "naroda@rexmyze.com",
    }
  ];
              ...
              <div className="lg:col-span-5 space-y-10">
                 ...
                 <div className="relative aspect-video rounded-[3rem] overflow-hidden border-[6px] border-primary shadow-2xl group">
                    ...
                    <div className="absolute inset-0 bg-primary/30 backdrop-blur-[2px] flex flex-col items-center justify-center p-8 text-center transition-all group-hover:backdrop-blur-0">
                       ...
                       <div className="bg-foreground text-background px-6 py-2 rounded-lg font-black text-sm uppercase tracking-widest shadow-2xl">
