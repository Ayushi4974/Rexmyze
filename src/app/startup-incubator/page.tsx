           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pt-10">
              {steps.map((step, i) => (
                <div key={i} className="relative group flex flex-col items-center text-center">
                   <div className="h-20 w-20 rounded-[2rem] bg-primary/10 flex items-center justify-center text-primary mb-10 group-hover:bg-primary group-hover:text-white transition-all shadow-xl shadow-primary/10">
                      <step.icon size={32} />
                   </div>
         ...
         <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-20 items-center">
               ...
               <div className="space-y-12">
                  <h2 className="text-4xl md:text-5xl font-black tracking-tighter leading-tight uppercase">Ready to <span className="highlight-red">Scale Your Startup?</span></h2>
                  <div className="space-y-8 font-medium italic">
                     <div className="flex gap-6 group">
                        <div className="h-12 w-12 rounded-xl bg-primary flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-all">
                  ...
                  <Button size="lg" className="w-full lg:w-auto py-10 px-16 text-xl font-black uppercase tracking-widest rounded-xl bg-primary hover:bg-primary/90 shadow-2xl shadow-primary/30">
                     Join the Next Batch
